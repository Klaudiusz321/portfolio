            ...
            <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl">
              <div className="absolute top-0 right-0">
                ...
                <div className='flex flex-col gap-5 text-white-600 my-5'>
                    ...
                    <p className='anmatedText'>{currentProject.desc}</p>
                    <p className='anmatedText'>{currentProject.subdesc}</p>
                </div>
                ...
                <div className='flex justify-between items-center mt-7'>
                  <button className='arrow-btn' onClick={() =>handleNavigation('previous')}>
                    <img src="/assets/left-arrow.png" alt="left arrow" className='w-4 h4' />
                  </button>
                  <button className='arrow-btn' onClick={() =>handleNavigation('next')}>
                    <img src="/assets/right-arrow.png" alt="right arrow" className='w-4 h4' />
                  </button>
                </div>
