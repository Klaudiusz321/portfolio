...
export const navLinks = [
  ...
  export const workExperiences = [
    ...
    },
    {
      ...
      duration: 'Present',
      title: "Specialized in building custom WordPress solutions to meet diverse business needs, from personal blogs to complex e-commerce platforms.",
      icon: '/assets/self-emplyed.svg',
      animation: 'victory',
    },
    {
      id: 3,
      name: 'Cracow University of Technology',
      pos: 'Technical physicist',
      duration: '2021 - 2025',
      title: "Graduate in Technical Physics, equipped with analytical skills and a problem-solving mindset, bridging the gap between science and technology.",
      icon: '/assets/uni.svg',
      animation: 'clapping',
    },
    {
